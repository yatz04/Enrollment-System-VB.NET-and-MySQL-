...
Public Class frm_Teacher
    ...
    Private Sub frm_Teacher_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        If isLogout = 0 Then
            Application.Exit()
        End If
    End Sub

    Private Sub frm_Teacher_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
